...
DECLARE_LOG_CATEGORY_EXTERN(LogOverCooked, Log, All);
...
#define PRINTLOG(fmt, ...) UE_LOG(LogOverCooked, Warning, TEXT("[%s]%s : %s"), NETMODE, *CALLINFO, *FString::Printf(fmt, ##__VA_ARGS__))